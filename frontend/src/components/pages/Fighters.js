    ...
    <div>
      <div style={{ opacity: 0 }} className="page-wrap">
          ...
          <div className="container nav-container">
            ...
            <div className="nav-right-wrap">
              <nav role="navigation" className="nav-menu w-nav-menu">
                ...
                <a href="/free-workouts" className="nav-link w-nav-link">
                  About
                </a>
                <a
                  href="/shop"
        ...
        <div className="section free-w-hero">
          <div className="container flex-center">
            <div className="hero-image-mask">
              <img
                src="/public/alora-griffiths-TTrTW-pFxKw-unsplash.jpg"
                sizes="95vw"
                alt=""
                className="hero-image"
              />
              <img
                src="/public/Group117.svg"
                alt=""
          ...
          <div className="container-2">
            ...
            <div className="comparison-table">
              <div className="comparison-row-main">
                // I want to have two columns here, one for fighter 1 and one
                for fighter 2 with dropdowns to select the fighters
              ...
              <div className="comparison-row">
                <div className="comparison-fighter1">
                  <select
                    onChange={(e) => handleSelectFighter1(e.target.value, true)}
                  >
                ...
                <div className="comparison-fighter2">
                  <select
                    onChange={(e) =>
                      handleSelectFighter1(e.target.value, false)
                    }
                  >
                    <option value="">Select Fighter</option>
                    {fighters.map((fighter, index) => (
        ...
        <div className="section newsletter-section">
          <img
            src="/public/anastase-maragos-7kEpUPB8vNk-unsplash.jpg"
            sizes="100vw"
            alt=""
            className="section-bg-image top-align"
          />
        </div>
        ...
        <div className="section footer-section">
          <div className="container footer-container">
            ...
            >
              ...
              <a href="/shop" aria-current="page" className="footer-link">
                Home
              </a>
              <a href="/free-workouts" className="footer-link">
                About
              </a>
              ...
              <a href="/brand-guidelines/style-guide" className="footer-link">
                Prediction
              </a>
            </div>
          </div>
