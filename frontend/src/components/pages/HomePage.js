        ...
        <div>
            ...
            <div className="gridFighter">
                <div className="fighter-icons">
                    <Link to="/Fighters"><img src="/Armen%20Petrosyan.png" alt="Fighter1"/></Link>
                    <Link to="/Fighters"><img src="/Caio%20Borralho.png" alt="Fighter2"/></Link>
                    <Link to="/Fighters"><img src="/Daniel%20Marcos.png" alt="Fighter3"/></Link>
                </div>
                <div className="fighter-icons">
                    <Link to="/Fighters"><img src="/Darren%20Till.png" alt="Fighter4"/></Link>
                    <Link to="/Fighters"><img src="/Derrick%20Lewis.png" alt="Fighter5"/></Link>
                    <Link to="/Fighters"><img src="/Elizeu%20Zaleski.png" alt="Fighter6"/></Link>
                </div>
                <div className="fighter-icons">
                    <Link to="/Fighters"><img src="/Gabriel%20Bonfim.png" alt="Fighter7"/></Link>
                    <Link to="/Fighters"><img src="/Ismael%20Bonfim.png" alt="Fighter8"/></Link>
                    <Link to="/Fighters"><img src="/Jailton%20Almeda.png" alt="Fighter9"/></Link>
                </div>
                <div className="fighter-icons">
                    <Link to="./Fighters"><img src="/Nicolas%20Dalby.png" alt="Fighter10"/></Link>
                    <Link to="./Fighters"><img src="/Rinat%20Fakhretdinov.png" alt="Fighter11"/></Link>
                    <Link to="./Fighters"><img src="/Rodolfo%20Vieira.png" alt="Fighter12"/></Link>
                </div>
            </div>
